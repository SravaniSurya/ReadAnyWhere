...
public class BookAdapterAdmin extends RecyclerView.Adapter<BookAdapterAdmin.ViewHolder> {
    ...
    private Context context;
        ...
        @Override
        public void onBindViewHolder(@NonNull BookAdapterAdmin.HolderPdfAdmin holder, int position) {
